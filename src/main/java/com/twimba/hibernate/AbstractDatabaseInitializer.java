...
/**
 * Abstract class to be implemented with the logic to initialize a database on runtime.
 * Usefull to be able to add tenants in runtime without any downtime to reconfigure the syste,
 * 
 * @author Luis Santos
 *
 */
